...
import wts.com.newdesigntask.device.Opts;
import wts.com.newdesigntask.device.PidOptions;
...
public class PaySprintActivity extends AppCompatActivity {
    ...
    private void doAepsTransaction() {
        ...
        Call<JsonObject> call = RetrofitClient.getInstance().getApi().doAepsTransaction(userId, selectedBankIIN, aadharNo, selectedTransactionType,
                pidData, mobileNo, lat, longi, amount);
                        ...
                        if (responseCode.equalsIgnoreCase("200")) {
                            ...
                            for (int i = 0; i < transactionArray.length(); i++) {
                                ...
                                if (transactionType.equalsIgnoreCase("MINI STATEMENT")) {
                                    ...
                                    Intent intent = new Intent(PaySprintActivity.this, MiniStatementPaySprintActivity.class);
                                    ...
                                    String accountBalance = transactionObject.getString("accountBalance");
                                    Intent intent = new Intent(PaySprintActivity.this, AepsTransactionActivity.class);
                                    intent.putExtra("transactionType", transactionType);
                                    intent.putExtra("bankName", bankName);
                                    intent.putExtra("responseMobileNumber", responseMobileNumber);
                                    intent.putExtra("responseAadharNumber", responseAadharNumber);
                            ...
                            progressDialog.dismiss();
                            String message = responseObject.getString("transactions");
