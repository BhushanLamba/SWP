...
public class UpiReportActivity extends AppCompatActivity {
    ...
    private void showBottomDateDialog() {
        ...
        fromDateLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog fromDatePicker = new DatePickerDialog(UpiReportActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        filterBtn.setOnClickListener(v -> {
            if (tvFromDate.getText().toString().equalsIgnoreCase("Select Date") ||
                ...
                new androidx.appcompat.app.AlertDialog.Builder(UpiReportActivity.this).setMessage("Please select both From date and To Date")
    ...
    private void getReport() {
        final android.app.AlertDialog pDialog = new android.app.AlertDialog.Builder(UpiReportActivity.this).create();
        ...
        Call<JsonObject> call = RetrofitClient.getInstance().getApi().getUpiReport("",userId,fromDate,toDate);
                    ...
                    try {
                        ...
                        if (statusCode.equalsIgnoreCase("200")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                upiReportModel.setTransactionId(transactionId);
                                upiReportModel.setAmount(amount);
                                upiReportModel.setStatus(status);
                                upiReportModel.setOpeningBalance(openingBalance);
                                upiReportModel.setClosingBalance(closingBalance);
                                ...
                                try {
                                    ...
                                    upiReportModel.setDate(outputDate);
                                    upiReportModel.setTime(outputTime);
                            ...
                            recyclerView.setLayoutManager(new LinearLayoutManager(UpiReportActivity.this,
                                    RecyclerView.VERTICAL, false));

                            UpiReportAdapter upiReportAdapter = new UpiReportAdapter(upiReportModelArrayList,
                                    UpiReportActivity.this,UpiReportActivity.this);
                            recyclerView.setAdapter(upiReportAdapter);
                            pDialog.dismiss();
                        }
