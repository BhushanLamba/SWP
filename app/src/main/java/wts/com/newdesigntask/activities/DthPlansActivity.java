...
import wts.com.newdesigntask.adapters.DthPlansAdapter;
import wts.com.newdesigntask.models.DthPlansModel;
...
public class DthPlansActivity extends AppCompatActivity {
    ...
    private void getPlans(String operator) {
        ...
        pDialog.show();
        Call<JsonObject> call = RetrofitClient.getInstance().getApiPlans().getDthMplan(operator);
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.isSuccessful()) {
                    try {
                        ...
                        String records=responseObject.getString("records");
