...
public class OnBoardPaySprintActivity extends AppCompatActivity {
    ...
    Button btnOnBoard;
    String name, mobileNo, email, firmName, userId;
    String partnerKey = "UFMwMDQ3MTcwNjA5MTFjYWYyMGE2NWI1MmEzOGFkNDQyMzE5MTU5";
    String partnerId = "PS00471";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firmName = sharedPreferences.getString("shopName",null);
