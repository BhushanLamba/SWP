...
import wts.com.newdesigntask.adapters.MyPagerAdapter;
import wts.com.newdesigntask.models.PlansModel;
import wts.com.newdesigntask.plansFragments.ComboFragment;
import wts.com.newdesigntask.plansFragments.Data2Fragment;
import wts.com.newdesigntask.plansFragments.DataFragment;
import wts.com.newdesigntask.plansFragments.FullTTFragment;
import wts.com.newdesigntask.plansFragments.RateCutterFragment;
import wts.com.newdesigntask.plansFragments.RoamingFragment;
import wts.com.newdesigntask.plansFragments.SMSFragment;
import wts.com.newdesigntask.plansFragments.TopUpFragment;
...
public class PlansActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        window.setStatusBarColor(ContextCompat.getColor(PlansActivity.this, R.color.purple_200));
        //////CHANGE COLOR OF STATUS BAR
    ...
    private void getPlans() {
        ...
        Call<JsonObject> call = RetrofitClient.getInstance().getApiPlans().getPlans(operator, commCircle);
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        JSONObject recordsObject = responseObject.getJSONObject("records");
